    ...
    <div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="grid  lg:grid-cols-12 gap-8">
                ...
                <div className="flex items-center ">
                  {activeSectionIndex !== 0 && (
                    <button
                      ...
                      className="flex items-center gap-1 p-3 text-sm font-medium text-gray-600 hover:bg-gray-50 transition-all"
          ...
          {/* {Right Panel- Preview} */}
          <div className="lg:col-span-7 max-lg:mt-16">
            <div className="relative w-full">{/* ---Buttons */}
                  <div className="absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2">
                    {resumeData.public && (
                      <button onClick={handleShare}  className="flex items-center p-2 px-4 gap-2 text-xs bg-gradient-to-br from-blue-100 to-blue-200 text-blue-600 ring-blue-300 rounded-lg hover:ring transition-colors">
