              ...
              >
                ...
                >
                  <TrashIcon
                    ...
                    className="size-7 p-1.5 hover:bg-white/50 rounded text-slate-700 transition-all duration-300"
                  />
                  <PencilIcon
                    onClick={() => {
          ...
          >
            ...
            >
              ...
              <input
                ...
                className="w-full px-4 py-2 mb-4 border focus:border-green-600 ring-green-600 required rounded-lg"
              />
