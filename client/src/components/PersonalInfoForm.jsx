        ...
        return (
          <div key={field.key} className="space-y-1 mt-5">
            ...
            <input
              ...
              className="mt-2 w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors text-sm"
            />
          </div>
        );
      })}
