        ...
        <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
          ...
          <div className="flex gap-2">
            ...
            <Link
              to={"/app"}
              hidden={!user}
              className="hidden md:block px-6 py-2 border bg-green-500 hover:bg-green-700 active:scale-95  text-white transition-all rounded-full text-slate-700 hover:text-slate-900"
            >
              Dashboard
            </Link>
          </div>
